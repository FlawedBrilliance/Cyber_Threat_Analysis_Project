...
class Cymon(object):
    ...
    def __init__(self, auth_token= '8d839c293762a7fe740d39decd0c86688f56489e', endpoint='https://api.cymon.io/v2/ioc/search'): #https://cymon.io/api/nexus/v1
    ...
    def domain_lookup(self, name):
        ...
        return json.loads(r.text)
    def hostname_lookup(self,hostname):
